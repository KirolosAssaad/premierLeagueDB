...
export default function viewTeam({ navigation }) {

  const viewTeamAPI = useApi(apis.getTeamInfo)
    ...
    const [data, setData] = useState('');
      ...
      const onSubmit = () => {
        ...
        viewTeamAPI.request(name).then((result)=>{
    ...
    if(viewTeamAPI.loading)
    return(
      <View style={styles.container}> 
      <ActivityIndicator loading = {viewTeamAPI.loading}/>
      </View> 
      )
    return (
